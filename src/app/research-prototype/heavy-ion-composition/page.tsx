...
export const metadata: Metadata = {
  title: 'Heavy Ion Composition (Prototype) | B. L. Alterman',
  description: 'How solar activity shapes elemental abundances - prototype page with rich summaries',
};

function loadTopicData(): ResearchTopicData {
  const filePath = path.join(process.cwd(), 'public/data/research-topics/heavy-ion-composition.json');
  const fileContents = fs.readFileSync(filePath, 'utf8');
  return JSON.parse(fileContents);
}

export default function HeavyIonCompositionPrototype() {
