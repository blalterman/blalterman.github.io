...
export const metadata: Metadata = {
  title: 'Solar Activity (Prototype) | B. L. Alterman',
  description: 'How the 11-year cycle reshapes solar wind composition - prototype page with rich summaries',
};

function loadTopicData(): ResearchTopicData {
  const filePath = path.join(process.cwd(), 'public/data/research-topics/solar-activity.json');
  const fileContents = fs.readFileSync(filePath, 'utf8');
  return JSON.parse(fileContents);
}

export default function SolarActivityPrototype() {
