...
export const metadata: Metadata = {
  title: 'Space Weather (Prototype) | B. L. Alterman',
  description: 'Mapping solar wind to its source on the Sun - prototype page with rich summaries',
};

function loadTopicData(): ResearchTopicData {
  const filePath = path.join(process.cwd(), 'public/data/research-topics/space-weather.json');
  const fileContents = fs.readFileSync(filePath, 'utf8');
  return JSON.parse(fileContents);
}

export default function SpaceWeatherPrototype() {
