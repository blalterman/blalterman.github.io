...
export default function TurbulencePage() {
  ...
  const pageData = figuresData.find((p: any) => p.slug === 'turbulence');
  const paragraph = paragraphs['turbulence'];
  const figure = pageData?.figure;

  return (
    <main className="flex-1 container mx-auto py-16 md:py-24">
      <h1 className="text-3xl md:text-4xl font-bold font-headline">Turbulence</h1>
