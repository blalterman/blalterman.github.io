...
export default function SourcesOfTheSolarWindPage() {
  ...
  const pageData = figuresData.find((p: any) => p.slug === 'sources-of-the-solar-wind');
  const paragraph = paragraphs['sources-of-the-solar-wind'];
  const figure = pageData?.figure;

  return (
    <main className="flex-1 container mx-auto py-16 md:py-24">
      <h1 className="text-3xl md:text-4xl font-bold font-headline">Sources of the Solar Wind</h1>
